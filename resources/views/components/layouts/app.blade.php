...
<head>
    ...
    <!-- Font-icon css-->
    <link rel="icon" type="image/png" href="{{ asset('images/bdc.png') }}"/>
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
</head>
<body class="app sidebar-mini rtl  sidenav-toggled pace-done">
<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="{{ route('index') }}">Pontos</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('register') }}"><i class="fa fa-user fa-lg"></i> Registrar</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('logout') }}"><i class="fa fa-sign-out fa-lg"></i> Sair</a>
                </li>
            </ul>
        </li>
    </ul>
...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        <li>
            <a class="app-menu__item" href="{{ route('index') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Atualizar Pontos</span></a>
        </li>
        <li>
            <a class="app-menu__item" href="{{ route('show') }}"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Verificar Pontos</span></a>
        </li>
        {{--<li class="treeview">
         ...
         <li class="treeview is-expanded">
             ...
             <ul class="treeview-menu">
                 <li>
                     <a class="treeview-item active" href="blank-page.html"><i class="icon fa fa-circle-o"></i> Blank Page</a>
                 </li>
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Pontos Gerencia</h1>
