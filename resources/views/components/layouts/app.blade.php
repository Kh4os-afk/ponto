...
<aside class="app-sidebar">
        ...
        {{--<ul class="app-menu">
            <li>
                <a class="app-menu__item" href="{{ route('index') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a>
            </li>
            <li class="treeview">
...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p>Verificar pontos da gerencia</p>
        </div>
